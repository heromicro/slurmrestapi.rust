...
pub struct Dbv0Period0Period37ClusterInfo {
    #[serde(rename = "controller", skip_serializing_if = "Option::is_none")]
    pub controller: Option<Box<crate::models::Dbv0037ClusterInfoController>>,
    ...
    pub associations: Option<Box<crate::models::Dbv0037ClusterInfoAssociations>>,
    /// Number rpc version
    ...
    pub tres: Option<Vec<crate::models::Dbv0Period0Period37ResponseTres>>,
}

impl Dbv0Period0Period37ClusterInfo {
    pub fn new() -> Dbv0Period0Period37ClusterInfo {
        Dbv0Period0Period37ClusterInfo {
            controller: None,
            flags: None,
            name: None,
            nodes: None,
