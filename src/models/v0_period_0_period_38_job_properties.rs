...
pub struct V0Period0Period38JobProperties {
    ...
    #[serde(rename = "oversubscribe", skip_serializing_if = "Option::is_none")]
...
impl V0Period0Period38JobProperties {
    pub fn new(environment: serde_json::Value) -> V0Period0Period38JobProperties {
