...
pub struct V0Period0Period37Reservation {
    /// Allowed accounts
    ...
    pub purge_completed: Option<Box<crate::models::V0037ReservationPurgeCompleted>>,
...
impl V0Period0Period37Reservation {
    pub fn new() -> V0Period0Period37Reservation {
