...
pub struct V0Period0Period38JobResponseProperties {
    ...
    pub array_max_tasks: Option<i32>,
    ...
    pub job_resources: Option<Box<crate::models::V0Period0Period38JobResources>>,
    /// state of the job
    ...
    pub last_sched_evaluation: Option<i32>,
    ...
    pub minimum_tmp_disk_per_node: Option<i32>,
...
impl V0Period0Period38JobResponseProperties {
    pub fn new() -> V0Period0Period38JobResponseProperties {
