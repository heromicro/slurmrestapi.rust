...
pub struct Dbv0Period0Period37CoordinatorInfo {
    /// Name of user
...
impl Dbv0Period0Period37CoordinatorInfo {
    pub fn new() -> Dbv0Period0Period37CoordinatorInfo {
        Dbv0Period0Period37CoordinatorInfo {
            name: None,
            direct: None,
        }
    }
