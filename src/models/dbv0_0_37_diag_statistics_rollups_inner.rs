...
pub struct Dbv0037DiagStatisticsRollupsInner {
    /// Type of rollup
...
impl Dbv0037DiagStatisticsRollupsInner {
    /// Rollup statistics
    pub fn new() -> Dbv0037DiagStatisticsRollupsInner {
        Dbv0037DiagStatisticsRollupsInner {
            r#type: None,
            last_run: None,
            last_cycle: None,
            max_cycle: None,
