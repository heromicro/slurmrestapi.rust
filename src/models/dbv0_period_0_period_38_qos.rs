...
/// Dbv0Period0Period38Qos : QOS description



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct Dbv0Period0Period38Qos {
    /// QOS description
    ...
    pub limits: Option<Box<crate::models::Dbv0038QosLimits>>,
    #[serde(rename = "preempt", skip_serializing_if = "Option::is_none")]
    pub preempt: Option<Box<crate::models::Dbv0038QosPreempt>>,
    /// QOS priority
...
impl Dbv0Period0Period38Qos {
    /// QOS description
    pub fn new() -> Dbv0Period0Period38Qos {
