...
pub struct V0Period0Period38Partition {
    /// partition options
    ...
    #[serde(rename = "maximum_memory_per_cpu", skip_serializing_if = "Option::is_none")]
    pub maximum_memory_per_cpu: Option<i64>,
    /// default MB memory per allocated node
    #[serde(rename = "default_memory_per_node", skip_serializing_if = "Option::is_none")]
    pub default_memory_per_node: Option<i64>,
}

impl V0Period0Period38Partition {
    pub fn new() -> V0Period0Period38Partition {
        V0Period0Period38Partition {
            ...
            total_nodes: None,
            tres: None,
            maximum_memory_per_cpu: None,
            default_memory_per_node: None,
        }
    }
}
