...
pub struct V0Period0Period39JobsResponse {
    ...
    pub jobs: Option<Vec<crate::models::V0Period0Period39JobInfo>>,
}

impl V0Period0Period39JobsResponse {
    pub fn new() -> V0Period0Period39JobsResponse {
