...
pub struct V0Period0Period39LicensesInfo {
    ...
    pub licenses: Option<Vec<crate::models::V0Period0Period39License>>,
}

impl V0Period0Period39LicensesInfo {
    pub fn new() -> V0Period0Period39LicensesInfo {
