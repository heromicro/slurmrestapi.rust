...
pub struct V0Period0Period39AssocUsage {
    ...
    pub group_used_wallclock: Option<f64>,
    #[serde(rename = "fairshare_factor", skip_serializing_if = "Option::is_none")]
    pub fairshare_factor: Option<f64>,
...
impl V0Period0Period39AssocUsage {
    pub fn new() -> V0Period0Period39AssocUsage {
        V0Period0Period39AssocUsage {
