...
pub struct V0038DiagStatistics {
    ...
    pub bf_table_size_mean: Option<i32>,
    ...
    pub rpcs_by_message_type: Option<Vec<crate::models::V0Period0Period38DiagRpcm>>,
    /// Remote Procedure Call statistics by user
    #[serde(rename = "rpcs_by_user", skip_serializing_if = "Option::is_none")]
    pub rpcs_by_user: Option<Vec<crate::models::V0Period0Period38DiagRpcu>>,
}

impl V0038DiagStatistics {
    /// Slurm statistics
    pub fn new() -> V0038DiagStatistics {
        V0038DiagStatistics {
            parts_packed: None,
            req_time: None,
            req_time_start: None,
